...
// AreaVariant lives here (the low-level painting layer) rather than in
// chart-context, so the Svelte kit stays free of the Vue-reactive chart context.
// chart-context re-exports it when the chart batch lands.
