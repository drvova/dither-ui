<script lang="ts" module>
  import { paintSoftAurora, type SoftAuroraParams } from "../engine/soft-aurora"
  export { paintSoftAurora }
...
<script lang="ts">
  ...
  const params = $derived<SoftAuroraParams>({
  ...
  const bg = $derived({
    ...
    render: (buffer: RasterBuffer, clock: number) => paintSoftAurora(buffer, params, clock, matrix),
  })
</script>
