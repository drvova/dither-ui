<script lang="ts" module>
  import { paintLiquidEther, type LiquidEtherParams } from "../engine/liquid-ether"
...
<script lang="ts">
  ...
  const params = $derived<LiquidEtherParams>({
  ...
  const bg = $derived({
    ...
    render: (buffer: RasterBuffer, clock: number) => paintLiquidEther(buffer, params, clock, matrix, mouseInteraction ? mouse : null),
  })
