<script lang="ts" module>
  import { paintFloatingLines, type FloatingLinesParams } from "../engine/floating-lines"
...
<script lang="ts">
  ...
  const params = $derived<FloatingLinesParams>({
  ...
  const bg = $derived({
    ...
    render: (buffer: RasterBuffer, clock: number) => paintFloatingLines(buffer, params, clock, matrix),
  })
</script>
