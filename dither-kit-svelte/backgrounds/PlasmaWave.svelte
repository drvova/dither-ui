<script lang="ts" module>
  import { paintPlasmaWave, type PlasmaWaveParams } from "../engine/plasma-wave"
  export { paintPlasmaWave }
...
<script lang="ts">
  ...
  const params = $derived<PlasmaWaveParams>({
  ...
  const bg = $derived({
    ...
    render: (buffer: RasterBuffer, clock: number) => paintPlasmaWave(buffer, params, clock, matrix),
  })
</script>
