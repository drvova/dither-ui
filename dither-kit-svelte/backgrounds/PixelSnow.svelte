<script lang="ts" module>
  import { paintPixelSnow, type PixelSnowParams } from "../engine/pixel-snow"
  export { paintPixelSnow }
...
<script lang="ts">
  ...
  const params = $derived<PixelSnowParams>({
  ...
  const bg = $derived({
    ...
    render: (buffer: RasterBuffer, clock: number) => paintPixelSnow(buffer, params, clock, matrix),
  })
</script>
