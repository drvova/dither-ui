...
<div class={cn("dither-sticker group relative inline-block", className)}>
  <div class="relative z-[1]">
    {@render children?.()}
  </div>
  <div class="dither-peel pointer-events-none absolute bottom-0 right-0" aria-hidden="true"></div>
</div>
