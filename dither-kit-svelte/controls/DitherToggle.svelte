<script lang="ts" module>
  ...
  import { BAYER4, clamp01 } from "../engine/pixel"
  import { createRasterBuffer, putRasterBuffer } from "../engine/raster"
...
<script lang="ts">
  ...
  import { fillOf, type PixelColor, pixelMatrixFromSeed } from "../engine/pixel"
