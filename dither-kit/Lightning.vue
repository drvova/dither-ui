...
const params = computed<LightningParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintLightning(buffer, params.value, clock, matrix.value),
})
</script>
