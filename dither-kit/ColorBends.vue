...
const params = computed<ColorBendsParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintColorBends(buffer, params.value, clock, matrix.value),
})
</script>
