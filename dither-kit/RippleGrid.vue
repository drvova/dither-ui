...
const params = computed<RippleGridParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintRippleGrid(buffer, params.value, clock, matrix.value),
})
</script>
