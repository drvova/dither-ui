...
const params = computed<HyperspeedParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintHyperspeed(buffer, params.value, clock, matrix.value),
})
</script>
