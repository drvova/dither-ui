...
const params = computed<LiquidChromeParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintLiquidChrome(buffer, params.value, clock, matrix.value),
})
</script>
