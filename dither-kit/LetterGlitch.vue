...
const params = computed<LetterGlitchParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintLetterGlitch(buffer, params.value, clock, matrix.value),
})
</script>
