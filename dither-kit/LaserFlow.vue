...
const params = computed<LaserFlowParams>(() => ({
...
useDitherBackground({
  ...
  render: (buffer: RasterBuffer, clock: number) => paintLaserFlow(buffer, params.value, clock, matrix.value),
})
</script>
